...
/*   Updated: 2019/02/05 12:05:00 by hutricot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "h.h"

static void	ft_cmpt(t_ptr ptr, t_point *p, int h[2], int axis)
{
	t_line l;
...
static void	ft_cmpt_line(t_ptr ptr, t_point *p, int h[2], int axis)
{
	t_line l;
